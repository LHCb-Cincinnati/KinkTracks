...
valx_100, valy_100, vale_100 = read_data('data/decay_length_data/DecayLength_100GeV_'+ln+'mm-0.dat')
valx_150, valy_150, vale_150 = read_data('data/decay_length_data/DecayLength_150GeV_'+ln+'mm-0.dat')
valx_200, valy_200, vale_200 = read_data('data/decay_length_data/DecayLength_200GeV_'+ln+'mm-0.dat')
valx_250, valy_250, vale_250 = read_data('data/decay_length_data/DecayLength_250GeV_'+ln+'mm-0.dat')
valx_300, valy_300, vale_300 = read_data('data/decay_length_data/DecayLength_300GeV_'+ln+'mm-0.dat')

# Create the plot
pp = PdfPages('DecayLength_combined_' + ln + 'mm.pdf')
tmp1 = plt.figure(1)
tmp1.set_size_inches(10.00, 6.00)
